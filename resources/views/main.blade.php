    ...
    <section class="bg-gray-100 dark:bg-gray-900">
        ...
        <div id="indicators-carousel" class="relative" data-carousel="static">
            ...
            <button type="button"
                ...
                data-carousel-prev>
                <span
                    class="inline-flex items-center justify-center w-8 h-8 rounded-full sm:w-10 sm:h-10 bg-gray-900/30 dark:bg-gray-100/30 group-hover:bg-gray-700/50 dark:group-hover:bg-gray-800/60 group-focus:ring-4 group-focus:ring-white dark:group-focus:ring-gray-800/70 group-focus:outline-none">
